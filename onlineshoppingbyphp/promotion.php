					    ...
					    <div class="owl-item">
					        <div class="bbb_viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
					            ...
					            <div class="pad15">
					            	...
					            	<p class="text-truncate"><?= substr($itname, 0,10). '...'; ?></p>
					            	<p class="item-price">
					            		<?php if ($discount) {  ?>
									...
									<a href="#" class="addtocartBtn text-decoration-none add_to_cart" data-id="<?= $itid; ?>" data-name="<?= $itname; ?>" data-photo="<?= $itphoto; ?>" data-codeno="<?= $itcodeno; ?>" data-price="<?= $itprice; ?>" data-discount="<?= $itdiscount; ?>" >Add to Cart</a>
					        	</div>
					        </div>
					    </div>
