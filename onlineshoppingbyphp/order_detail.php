<?php 
	...
	$sql="SELECT orders.*, users.name as uname, users.address as uaddress, users.phone as uphone, users.email as uemail FROM orders INNER JOIN users ON orders.user_id=users.id WHERE orders.voucherno=:voucherno";
	...
	//die();
	 ...
	 $sql = "SELECT * FROM item_order INNER JOIN items ON item_order.item_id = items.id WHERE item_order.order_id = :value1";
