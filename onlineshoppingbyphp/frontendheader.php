...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="add_to_cart.js">
</head>
<body>
		...
		<div class="row shadow-sm p-3 bg-white rounded d-flex align-items-center">
			...
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-6 order-xl-3 order-lg-3 order-md-4 order-sm-4 order-4 text-right">
				...
				<a href="shoppingcart.php" class="text-decoration-none d-xl-inline d-lg-inline d-md-inline d-sm-none d-none shoppingcartLink"> 
					...
					<span class="badge badge-pill badge-light badge-notify cartNotistyle " id="cart"> 0 </span>
					<span id="amout"> 0 Ks </span>
				</a>
			        ...
			        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        ?>
			          	<li class="dropdown-submenu">
			          		<a class="dropdown-item" href="subcategory.php?id=<?= $sid ?>">
			          			<?= $name ?>
			...
			<div class="col-3">
				<div class="hov-dropdown d-inline-block">
          			...
          			<div class="dropdown-menu" aria-labelledby="navbarDropdown2">
          				...
          				?>
            			<a class="dropdown-item" href="brand.php?id=<?= $bid ?>"><?= $name ?></a>
            			<?php } ?>
          			</div>
	...
	<div id="mySidebar" class="sidebar">
		...
		<div class="mt-3">
			<p class="text-muted ml-4"> Shop Bys </p>
			<hr>
			...
			?>
		  	<a data-toggle="collapse" href="subcategory.php" role="button" aria-expanded="false" aria-controls="category">
		   		<?= $name ?>
		   		<i class="icofont-rounded-down float-right mr-3"></i>

		  	</a>

			<div class="collapse sidebardropdown_container_category mt-3" id="category_<?= $id ?>"><!--show by id divided--->
			...
			<hr>
		  	...
		  	<a data-toggle="collapse" href="brand.php" role="button" aria-expanded="false" aria-controls="brand">
		   		Merchants
		   		<i class="icofont-rounded-down float-right mr-3"></i>
				...
				<?php 
					...
					$sql="SELECT * FROM brands";
                            ...
                            foreach ($rows as $row) {
                                ...
                                $name=$row['name'];
				?>
			    <a href="brand.php?id=<?= $bid ?>" class="py-2"> <?= $name ?> </a>
			    <?php } ?>
			</div>
			<hr>
			...
			<?php 
						...
						?>
						<a href="javascript:void(0)" class="d-xl-block d-lg-block d-md-block d-block  text-decoration-none loginLink float-right" data-toggle="dropdown" role="button"> 
							<?= $_SESSION['login_user']['name']; ?>
							<i class="icofont-rounded-down"></i>
							<hr>
						</a>
					...
					<?php } else { ?>
						<a href="login.php" class="d-xl-block d-lg-block d-md-block  d-block text-decoration-none loginLink float-right"> Login | Sign-up </a>
						<hr>
						<?php } ?>
			<!-- <a href="login.php"> Login | Signup</a> -->
			<hr>

			<a href="shoppingcart.php"> Cart [ <span class="cartnoti"> 0 </span> ]  </a>
			<hr>
