<?php 
	...
	$sql = "SELECT items.*, brands.name as bname, categories.name as cname,subcategories.name as sname, subcategories.id as sid FROM items LEFT JOIN brands ON items.brand_id = brands.id LEFT JOIN subcategories ON items.subcategory_id = subcategories.id LEFT JOIN categories ON subcategories.category_id = categories.id WHERE items.id =:id";
    ...
    // Related Item
    	$rsql = "SELECT * FROM items WHERE subcategory_id=$sid ORDER BY rand() limit 4";
	...
	<div class="container">
		...
		<div class="row mt-5">
			...
			<div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
				...
				<a href="javascript:void(0)" class="addtocartBtn text-decoration-none add_to_cart" data-id="<?= $itid ?>" data-name="<?= $itname; ?>" data-photo="<?= $itphoto; ?>" data-codeno="<?= $itcodeno; ?>" data-price="<?= $itprice; ?>" data-discount="<?= $itdiscount; ?>">
		...
		<div class="row mt-5">
			...
			<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12">
				<a href="itemdetail.php?id=<?= $ritid ?>">
